...
SELECT * FROM country WHERE region ILIKE '%southern%europe%' ORDER BY population ASC LIMIT 1;
...
-- the airport, and is headed towards the capital! Look up the country's 
